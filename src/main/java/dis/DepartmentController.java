...
public class DepartmentController {
	...
	public String submitForm(@ModelAttribute("department") Department department, BindingResult result,
		...
		for (ConstraintViolation<Department> violation : violations) {
			...
			result.addError(new FieldError("department", propertyPath,
		...
		// Store the department information in database
		// manager.createNewRecord(department);
